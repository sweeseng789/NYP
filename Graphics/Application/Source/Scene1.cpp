...
void Scene1::Init()
{
	...
	static const GLfloat vertex_buffer_data[] = {
		0.0f, 0.9f, 0.0f, //vertex 0 of triangle
		-0.5f, -0.7f, 0.0f, //vertex 1 of triangle
		0.3f, -0.1f, 0.0f, //vertex 2 of triangle

		-0.8f, 0.3f, 0.0f, //vertex 0 of triangle
		0.8f, 0.3f, 0.0f, //vertex 1 of triangle
		0.0f, -0.3f, 0.0f, //vertex 2 of triangle
	...
	static const GLfloat vertex_buffer_data2[] = {
		...
		0.4f, 0.9f, 0.0f, //vertex of vertex 1
		0.0f, 0.0f, 0.0f, //vertex of vertex 2

		0.4f, 0.9f, 0.0f, //vertex of vertex 0
		0.9f, 0.4f, 0.0f, //vertex of vertex 1
		0.0f, 0.0f, 0.0f, //vertex of vertex 2
...
void Scene1::Render()
{
	...
	// Draw the triangle
	glDrawArrays(GL_TRIANGLES, 0, 24); // Starting from vertex 0; 3vertices = 1 triangle
	*/
	// Polygon
