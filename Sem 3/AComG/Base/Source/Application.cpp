...
void Application::Run()
{
	...
	while (!glfwWindowShouldClose(m_window) && !IsKeyPressed(VK_ESCAPE))
	{
		...
		m_dAccumulatedTime_SceneUpdate += m_dElapsedTime;
		m_dAccumulatedTime_MouseUpdate += m_dElapsedTime;
...
bool Application::GetMouseUpdate()
{
	...
	//Do a wraparound if mouse cursor goes out of deadzone
	if ((mouse_current_x < m_window_deadzone) ||
		(mouse_current_x > m_window_width - m_window_deadzone))
	{
	...
	//Storing current position as last position
