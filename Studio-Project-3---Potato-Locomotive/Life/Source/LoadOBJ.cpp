...
\param file_path - The path of the OBJ file to load
\param out_vertices - The vector to store the vertices of the OBJ
\param out_uvs - The vector to store the texture coordinates of the OBJ
\param out_normals - The vector to store the normals of the OBJ

\return if the loading of the file was successful
*/
/******************************************************************************/
bool LoadOBJ(
...
/*!
\brief
Indexes the Vertex Buffer Object

\param in_vertices - The vector to retrieve the vertices of the VBO
\param in_uvs - The vector to retrieve the coordinates of the VBO
\param in_normals - The vector to retrieve the normals of the VBO
\param out_indices - The vector to store the indices of the VBO
\param out_vertices - The vector to store the vertices of the VBO
