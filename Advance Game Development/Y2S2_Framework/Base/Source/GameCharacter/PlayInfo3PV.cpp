...
void CPlayInfo3PV::Init()
{
	...
	transform = new CTransform();
	nodeInfo = new std::pair<int, std::string>();
	newModel->setMesh(CModel::s_HIGH, MeshBuilder::GenerateOBJ("Unicorn Shield", "OBJ//Unicorn_Shield.obj"), "Image//Unicorn_Gundam//Unicorn_Shield.tga");
	...
	transform = new CTransform();
	nodeInfo = new std::pair<int, std::string>();
	newModel->setMesh(CModel::s_HIGH, MeshBuilder::GenerateOBJ("Beam Magnum", "OBJ//Beam_Saber.obj"), "Image//Unicorn_Gundam//Beam_Saber.tga");
