...
int main()
{
	...
	std::cout << "Please enter the IP Address to connect to" << std::endl;
	...
	std::cout << std::to_string(addr.sin_addr.S_un.S_un_w.s_w1) << std::endl;
	std::cout << std::to_string(addr.sin_addr.S_un.S_un_w.s_w2) << std::endl;
